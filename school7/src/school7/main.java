...
public class main {
    private static final String URL = "jdbc:mysql://localhost:3306/school7";
    private static final String USER = "root";
    private static final String PASSWORD = "1320@QWERTYy";
    ...
    private static void retrieveMarkRecord(Statement stmt, Scanner scanner) throws SQLException {
        ...
        String retrieveStudentDetails = "SELECT * FROM school7table3 WHERE name=?";
    ...
    public static class StudentDetails {
        ...
        public static void studentTable(Statement stmt) throws SQLException {
            String studentTable = "CREATE TABLE IF NOT EXISTS school7table1 " +
    ...
    public static class MarksDetails {
        ...
        public static void marksTable(Statement stmt) throws SQLException {
            String marksTable = "CREATE TABLE IF NOT EXISTS school7table3 " +
                    "(name VARCHAR(255), " +
                    "english INT, " +
                    "mathematics INT, " +
                    "science INT, " +
    ...
    private static void createRecord(Statement stmt, Scanner scanner) throws SQLException {
        ...
        String insertStudentDetails = "INSERT INTO school7table1 VALUES (?, ?, ?, ?, ?)";
